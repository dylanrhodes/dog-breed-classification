...
def train_conv_network(X, y, flip_idxs, out_file_name):
	conv_net = NeuralNet(
		...
		conv1a_num_filters=16, conv1a_filter_size=(11, 11), conv1a_nonlinearity=rectify_leaky, 
	    conv1_num_filters=32, conv1_filter_size=(7, 7), conv1_nonlinearity=rectify_leaky, pool1_ds=(2, 2), dropout1_p=0.1,
